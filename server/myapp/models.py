...
class Thing(models.Model):
    ...
    yysj = models.CharField(max_length=50, blank=True, null=True)  # 营业时间
    wxts = models.CharField(max_length=100, blank=True, null=True)  # 温馨提示
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
...
class Order(models.Model):
    ...
    receiver_time = models.CharField(max_length=50, blank=True, null=True)  # 预约场次
